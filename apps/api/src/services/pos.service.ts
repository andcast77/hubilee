...
import type { CompanyContext, PosContext } from '../core/auth-context.js'
import * as productsService from './products.service.js'
import { NotFoundError, BadRequestError, ForbiddenError } from '../common/errors/app-error.js'
import { createRepositories } from '../repositories/index.js'
import { canAccessUserPreferences, hasFullStoreAccess } from '../policies/pos-authorization.policy.js'
...
// --- Stores ---
export async function listStores(ctx: PosContext, includeInactive?: string) {
...
export async function getStoreByCode(ctx: PosContext, code: string) {
...
export async function getStoreById(ctx: PosContext, id: string) {
...
// --- Export ---
export { exportJson, exportCsv } from './pos-export.service.js'

// --- Categories ---
export { listCategories, getCategoryById, createCategory, updateCategory, deleteCategory } from './pos-categories.service.js'

// --- Suppliers ---
export { listSuppliers, getSupplierById, createSupplier, updateSupplier, deleteSupplier } from './pos-suppliers.service.js'

// --- Customers ---
export { listCustomers, getCustomerById, createCustomer, updateCustomer, deleteCustomer } from './pos-customers.service.js'
export { createAction, listActions } from './pos-action-history.service.js'
...
} from './pos-notifications.service.js'
...
// --- Push subscriptions ---
export async function listPushSubscriptions(ctx: PosContext, userId: string) {
...
export async function createPushSubscription(ctx: PosContext, body: { userId?: string; endpoint: string; p256dh: string; auth: string }) {
...
export async function deletePushSubscription(ctx: PosContext, endpoint: string) {
