...
import { openCashSessionSchema, closeCashSessionSchema } from '../../../dto/pos.dto.js'
...
export function registerRoutes(fastify: FastifyInstance) {
  fastify.get(
    ...
    { preHandler: [...pre, requirePermission('pos.cash-sessions', 'read')] },
    handle(listCashSessions),
  )
  fastify.post(
    '/v1/pos/cash-sessions/open',
    { preHandler: [...pre, requirePermission('pos.cash-sessions', 'open')] },
    handle(openCashSession),
  )
  fastify.post<{ Params: { id: string } }>(
    '/v1/pos/cash-sessions/:id/close',
    { preHandler: [...pre, requirePermission('pos.cash-sessions', 'close')] },
    handle(closeCashSession),
  )
  fastify.get<{ Params: { id: string } }>(
    '/v1/pos/cash-sessions/:id/report',
    { preHandler: [...pre, requirePermission('pos.cash-sessions', 'read')] },
