...
export function hasFullStoreAccess(ctx: Pick<PosContext, 'membershipRole' | 'isSuperuser'>): boolean {
 ...
 * against `UserStore` membership by `requirePosContext`. Deny-by-default: a null
