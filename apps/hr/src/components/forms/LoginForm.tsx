...
type CompanyOption = { id: string; name: string; hrEnabled?: boolean; posEnabled?: boolean };
...
export default function LoginForm() {
  ...
  if (mfaStep && mfaTempToken) {
    return (
      <AuthLayout variant="brand" panel={hrPanel}>
        <AuthBrandWelcomeHeader subtitle="Accede a tu cuenta de Hr" />
        <AuthBrandCard
