          ...
          {site.projects.items.map((p, i) => (
            <Reveal key={p.title}>
              <Card className="hover:scale-[1.02] transition-transform duration-300">
                <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--radius-section)] border border-[var(--color-border)] bg-[var(--color-background)] shadow-[var(--shadow-soft)]">
                  <div
                ...
                <div className="mt-4 text-center text-sm font-semibold uppercase tracking-wide text-[var(--color-heading)] transition-colors group-hover:text-[var(--color-accent-bright)]">
                  {p.title}
                </div>
              </Card>
            </Reveal>
