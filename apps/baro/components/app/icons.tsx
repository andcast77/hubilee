...
export function IconRuler(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M4 8l12 12M8 4l2 2M6 6l2 2M10 2l2 2M14 6l2 2M12 8l2 2M16 4l2 2M18 6l2 2"
        strokeLinecap="round"
      />
    </svg>
  )
...
export function IconWallet(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M19 7V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 002-2v-2M3 9h14v10H3V9z"
        strokeLinejoin="round"
      />
...
export function IconCompass(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M14.5 9.5l-3 5-2-2 3-5 2 2z" strokeLinejoin="round" />
    </svg>
  )
}
